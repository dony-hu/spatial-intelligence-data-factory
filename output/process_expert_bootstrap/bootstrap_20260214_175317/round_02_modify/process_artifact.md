...
- `quality_evaluator`: 质量评估器 - 自动生成 | 脚本路径: `/Users/huda/Code/worktrees/factory-address-verify/output/process_expert_bootstrap/bootstrap_20260214_175317/round_02_modify/tool_scripts/quality_evaluator.py`
- `data_generator`: 数据生成器 - 自动生成 | 脚本路径: `/Users/huda/Code/worktrees/factory-address-verify/output/process_expert_bootstrap/bootstrap_20260214_175317/round_02_modify/tool_scripts/data_generator.py`
- `db_persister`: 数据库持久化器 - 自动生成 | 脚本路径: `/Users/huda/Code/worktrees/factory-address-verify/output/process_expert_bootstrap/bootstrap_20260214_175317/round_02_modify/tool_scripts/db_persister.py`
