...
4. `docs/99_研发过程管理/归档/截止2026-03-05/` 用于存放 `2026-03-05` 及之前的历史过程文档；归档文档不得再当作当前实施基线。
...
9. 被替代的 dated 正式文档、一次性评审文档、阶段性过程文档，必须迁入 `archive/docs/` 或 `docs/99_研发过程管理/归档/` 对应分区。
