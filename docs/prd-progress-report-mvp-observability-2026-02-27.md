...
1. PRD：`docs/prd-spatial-intelligence-data-factory-2026-02-27.md`
2. MVP Epic：`docs/epic-address-governance-mvp-2026-02-27.md`
3. 可观测性架构：`docs/architecture-observability-capability-2026-02-27.md`
...
- `docs/prd-review-address-governance-mvp-2026-02-27.md` 总体结论已更新为“阶段性通过（Conditional Pass）”。
