...
| `trust_meta` | 可信来源与能力元数据 | `source_registry`、`source_snapshot`、`active_release`、`capability_registry` | 迁移物理表 + bootstrap 补齐 |
...
2. 快照与发布 `source_snapshot`、`active_release`
3. 能力目录 `capability_registry`
