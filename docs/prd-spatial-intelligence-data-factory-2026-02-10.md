...
## 9. 专项补充：模拟逻辑替换真实执行（2026-02-12）

为解决“流程完成但业务产物无效”的问题，新增 BMAD 专项工程化执行包，覆盖真实清洗、真实图谱、状态语义修正、看板可观测与 CI 门禁。

专项文档：

- `docs/bmad-real-execution-engineering-plan-2026-02-12.md`

该专项交付后，`completed` 状态必须与产物门禁一致，禁止出现“图谱零产出但仍成功”的语义偏差。
