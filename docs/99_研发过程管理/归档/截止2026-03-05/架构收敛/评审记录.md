...
1. 研发主题：`docs/99_研发过程管理/归档/截止2026-03-05/架构收敛/主题说明.md`
2. PG-only 专项：`docs/99_研发过程管理/归档/截止2026-03-05/PG-only与SQLite退役/主题说明.md`
...
1. 形成 `.venv` 专项处置记录并明确后续策略（已在 `docs/99_研发过程管理/归档/截止2026-03-05/项目管理/开发环境治理.md` 持续更新）。
